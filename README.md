...
A Claude Code skill for uploading Claude Code skills to claude.ai, making them available in Claude Desktop via cloud sync.
...
```bash
# Run install
npx skills add HartreeWorks/skill--sync-skill-to-claude-desktop
